    ...
    <ul class="navbar-nav mr-auto">
      ...
      <button class=" dropbtn">VIDEOS</button>
        <div class="dropdown-content" id="myBtnContainer">
          <a id="drop" class="filt active" href="#"  onclick="filterSelection('all')">TOUT</a>
          <a id="drop" class="filt" href="#"  onclick="filterSelection('sport')">SPORT</a>
          <a id="drop" class="filt" href="#"  onclick="filterSelection('yoga')">YOGA</a>
          <a id="drop" class="filt" href="#"  onclick="filterSelection('autres')">AUTRES VIDEOS</a>
        </div>
      </li>
    </ul>
    <?php
